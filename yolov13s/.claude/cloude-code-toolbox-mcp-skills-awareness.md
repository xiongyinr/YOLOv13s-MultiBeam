...
_Generated: 2026-05-08T03:27:22.780Z_
...
Workspace `mcp.json` _(folder: yolov13-main)_

- **d:\毕业论文\YOLO\yolov13-main\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\admin\.claude.json** — _File exists — no servers defined_
